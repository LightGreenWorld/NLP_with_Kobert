...
저는 SKT에서 pre-train한 KoBERT를 활용하여 해당 과제를 수행하였으며, 아래 RAVI TANWAR의 BERT for English Grammar Checking 글을 참고하여 코드를 전개하였습니다. 
...
Since copyright of Train, Dev and Test datasets of this project belongs to National Institute of Korean Language, I don't upload them.
